...
## Update (2026-09, test-suite support deferred)

This ADR decides *when* the live suite runs, not what it's made of — that part (P3-03, demo-project repo) is intentionally deferred to a future update, not scoped yet. Two layers are wanted, not just the one this ADR describes:
