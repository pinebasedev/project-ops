...
banner "Deploy the platform behind Cloudflare Access"
...
say ""
say "Only one Google account may log in to the dashboard."
ask CF_ACCESS_ALLOW_EMAIL "The email address allowed to log in:"
...
say "Next: onboard a managed project with scripts/onboard-project.sh."
